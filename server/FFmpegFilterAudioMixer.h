...
class FFmpegFilterAudioMixer {
public:
    using Ptr = std::shared_ptr<FFmpegFilterAudioMixer>;
    ...
    FFmpegFilterAudioMixer() {
        // avfilter_register_all();
        av_log_set_level(AV_LOG_DEBUG);
        running_ = true;
        outputThread_ = std::thread(&FFmpegFilterAudioMixer::outputThreadFunc, this);
    }
